...
public class HibernateHelper extends HelperBase {
    ...
    private static ContactData convertContact(ContactRecord record) {
        return new ContactData("" + record.id, record.firstname, record.lastname, "", record.nickname, "", "", "", record.address, record.phoneHome, "", "", "", record.email, "", "", "", "",
                "", "", "", "", "", "");
    }
    ...
    private static ContactRecord convertContact(ContactData data) {
        ...
        return new ContactRecord(Integer.parseInt(id), data.firstName(), data.middleName(), data.lastName(), data.nickName(),
                data.company(), data.title(), data.address(), data.phoneHome(), data.phoneMobile(), data.phoneWork(), data.phoneFax(),
